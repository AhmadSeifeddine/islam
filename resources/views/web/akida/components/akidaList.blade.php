...
<div class="container py-20" dir="rtl">
    <div class="row justify-content-center mb-8">
        <div class="col-lg-8 text-center">
            <h2 class="display-2 fw-bold mb-4">العقيدة <span class="gold">الإسلامية</span></h2>
            <p class="lead text-body-secondary fs-4 mb-0">تعرف على أصول العقيدة الإسلامية الصحيحة وفق منهج أهل السنة والجماعة من خلال كتابات العلماء الموثوقين</p>
        </div>
    </div>
