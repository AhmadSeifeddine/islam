<div class="container py-7" dir="rtl">
    <div class="row justify-content-center mb-6">
        <div class="col-lg-8 text-center">
            <h2 class="display-2 fw-bold mb-4">فيديوهات <span class="gold">مختارة</span></h2>
            <p class="lead text-body-secondary fs-4 mb-0">اكتشف مجموعة متميزة من المحاضرات والدروس الإسلامية من علماء
                ودعاة موثوقين</p>
        </div>
    </div>
