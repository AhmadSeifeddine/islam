...
{{-- <section class="about_us_section my-5">
    <div class="container-xl blur_bg_color d-flex align-items-center flex-wrap flex-md-nowrap gap-5 rounded-3 py-5 my-5">
        <div class="about_us p-5 rounded-3">
            <h3 class="pb-5">
                <svg width="35" height="35" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <polygon points="352,128.4 319.7,96 160,256 160,256 160,256 319.7,416 352,383.6 224.7,256 "/>
                </svg>
                معلومات عنا
            </h3>
            <p class="fs-4 fw-semibold">مرحباً بك في عالم اللغة العربية الجميل! تعتبر اللغة العربية من أقدم وأغنى اللغات في العالم، حيث يتحدث بها
                أكثر من ٤٠٠ مليون شخص. تتميز هذه اللغة بجمال خطها وثراء مفرداتها وعمق معانيها، كما أنها لغة القرآن
                الكريم والتراث الإسلامي. على مر التاريخ، قدمت الحضارة العربية إسهامات عظيمة في مجالات العلوم والفلسفة
                والأدب والفنون، وما زالت هذه اللغة تلعب دوراً مهماً في الثقافة العالمية المعاصرة.</p>
        </div>
        <div class="w-100 w-md-auto h-0px h-md-250px rounded-1 mx-5" style="border: 3px solid var(--gold);"></div>
...
<section class="about_us_section my-5">
    <div class="container-xl blur_bg_color d-flex align-items-center flex-wrap flex-md-nowrap gap-10">
        <div class="about_us p-5 rounded-3">
            <h3 class="pb-5">
