        ...
        <div class="container">
            ...
            d-flex align-items-center flex-wrap justify-content-center justify-content-lg-between gap-4">
                ...
                <div class="box_search position-relative w-100 w-lg-300px w-xl-400px">
                    ...
                    <!--begin::Input-->
                    <input type="text" class="search-input form-control form-control shadow border w-100 h-lg-45px pe-10"
            ...
            d-flex align-items-center flex-wrap justify-content-center justify-content-lg-between gap-4">
                ...
                <div class="box_search position-relative w-100 w-lg-300px w-xl-400px">
                    ...
                    <!--begin::Input-->
                    <input type="text"
                        class="search-input form-control form-control shadow border w-100 h-lg-45px  pe-10" name="search"
                        value="" placeholder="البحث..." data-kt-search-element="input">
                    <!--end::Input-->
                </div>
            </div>
