    ...
    <div class="modal-dialog modal-dialog-centered {{ 'modal-' . $size }}">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                @else
                    @if ($showCloseButton)
                        <button type="button" class="btn close-modal btn-light" data-bs-dismiss="modal">
                            {{ __('common.close') }}
                        </button>
                    @endif
                    @if ($showSubmitButton)
                        <button type="submit" loading-text="loading" submit-form-id="{{ $submitFormId }}"
                            with-spinner="true" class="btn btn-primary" id="{{ $submitButtonId }}">
                            <span class="ld-span">{{ __('common.dashboard.submit') }}</span>
                        </button>
                    @endif
                @endif
            </div>
