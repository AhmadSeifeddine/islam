                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    {{-- you need to enter the user name here (logged in user) --}}
                                    <div class="fw-bold d-flex align-items-center fs-5">Ahmad Seifeddine
                                    </div>
                                    <a href="#"
                                        class="fw-semibold text-muted text-hover-primary fs-7">ahmadseifeddine@gmail.com</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
