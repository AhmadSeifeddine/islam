    ...
    <div class="row mb-3">
        <div class="col-md-12">
            ...
            <select feedback-id="type-feedback" class="form-select" name="type" id="type_select"
                data-control="select2" data-placeholder="Select a type" value="{{ $youtube->type }}">
                <option value="">Select Type</option>
                <option value="video" {{ $youtube->type == 'video' ? 'selected' : '' }}>Video</option>
                <option value="audio" {{ $youtube->type == 'audio' ? 'selected' : '' }}>Audio</option>
            </select>
