...
@php
    $columns = ['name', 'scholar', 'category', 'publication_date', 'genre', 'language', 'status', 'actions'];
@endphp
...
---------------------------->
@section('content')
    <x-lebify-table id="bookTable" :columns="$columns" {{-- create="true"                         // BY DEFAULT TRUE
...
---------------------------->
@push('scripts')
<script src="{{ asset('js/dashboard/book.js') }}" type="module" defer></script>
@endpush
