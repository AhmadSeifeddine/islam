...
@section('toolbar')
    @include('dashboard.components.toolbar', [
        'title' => 'Writing',
        'currentPage' => 'Writing Management',
    ])
@endsection
...
@php
    $columns = ['title', 'category', 'scholar', 'writing_type', 'status', 'actions'];
@endphp
...
---------------------------->
@push('scripts')
<script src="{{ asset('js/dashboard/article.js') }}" type="module" defer></script>
@endpush
