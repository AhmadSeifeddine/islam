...
<!---------------------------
    Title
---------------------------->
@section('title', 'Book_Explanation')
...
@section('toolbar')
    @include('dashboard.components.toolbar', [
        'title' => 'Book_Explanation',
        'currentPage' => 'Book_Explanation Management',
    ])
@endsection
...
@php
$columns = ['book_id', 'youtube_id', 'status', 'actions'];
@endphp
...
---------------------------->
@push('scripts')
    <script src="{{ asset('js/dashboard/bookExplanation.js') }}" type="module" defer></script>
@endpush
