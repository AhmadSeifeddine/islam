    ...
    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
        ...
        <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
            ...
            <a href="index.html">
                ...
                <img alt="Logo" style="height: 35px"
                    src="{{ asset('core/vendor/img/logo/logo-no-background.svg') }}"
                    ...
                    <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link active" href="index.html">
                                        ...
                                        <span class="menu-title">{{ __('common.dashboard.default') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                        ...
                        <div class="menu-item pt-5">
                            ...
                            <div class="menu-content">
                                <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('common.dashboard.pages') }}</span>
                            </div>
                            <!--end:Menu content-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ __('common.dashboard.users_profile') }}</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                            <!--begin:Menu sub-->
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="pages/user-profile/projects.html">
                                        ...
                                        <span class="menu-title">{{ __('common.dashboard.projects') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
