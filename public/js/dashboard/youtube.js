 ...
 *
 * This module handles all youtube-related operations in the dashboard including:
 ...
 * @function buildApiUrl - Constructs API endpoints for youtube operations
 *--------------------------------------------------------------------------*/
const defaultErrorHandler = (err) => console.error('Error:', err);
const reloadDataTable = () => youtubeTable.reload();
const buildApiUrl = (path) => `${DASHBOARD_URL}/youtubes/${path}`;
 ...
 * Defines the structure and behavior of the Youtube management table
 *--------------------------------------------------------------------------*/
const tableColumns = [
    {
        "data": "id"
...
/*---------------------------------------------------------------------------
 * Bulk Action Handler
 * Processes operations on multiple selected youtubes
 * @param {Array} selectedIds - Array of selected youtube IDs
 *--------------------------------------------------------------------------*/
const handleBulkActions = (selectedIds) => {
    // Implementation for bulk actions
    // Example: Delete multiple youtubes, change status, etc.
};

/*=============================================================================
 * DataTable Initialization
 * Creates and configures the main youtube management interface
 *============================================================================*/
export const youtubeTable = new $DatatableController('youtubeTable', {
...
// Initialize create youtube modal
createModalLoader({
