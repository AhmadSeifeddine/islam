 ...
 *
 * This module handles all article-related operations in the dashboard including:
...
const userActionHandlers = {
    ...
    edit: function (id) {
        this.callCustomFunction('_EDIT_', id, buildApiUrl(`${id}/edit`), (response) => {
            ...
            const textarea = document.getElementById('content-textarea-edit');

            var Size = Quill.import('attributors/style/size');
            Size.whitelist = ['8px', '10px', '12px', '14px', '16px', '18px', '20px', '24px', '32px', '48px', '100px'];
            ...
            const quill = new Quill('#content', {
                ...
                formats: [
                    ...
                    'color', 'background', 'code-block', 'image', 'video', 'link', 'list', 'bullet',
                    'align', 'clean', 'lineHeight'
                ],
                width: '100%',
                height: '300px',
            });
 ...
 * Defines the structure and behavior of the Article management table
 *--------------------------------------------------------------------------*/
const tableColumns = [
    {
        "data": "id",
...
/*---------------------------------------------------------------------------
 * Bulk Action Handler
 * Processes operations on multiple selected articles
 * @param {Array} selectedIds - Array of selected article IDs
 *--------------------------------------------------------------------------*/
const handleBulkActions = (selectedIds) => {
    // Implementation for bulk actions
    // Example: Delete multiple articles, change status, etc.
};

/*=============================================================================
 * DataTable Initialization
 * Creates and configures the main article management interface
 *============================================================================*/
export const articleTable = new $DatatableController('articleTable', {
...
// Initialize create article modal
createModalLoader({
